                ...
                <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                    ...
                    <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        ...
                        <div class="mt-5 flex items-center">
                            ...
                            <p v-if="product.rating != undefined" class="ml-2 text-sm font-medium text-gray-500">{{ product.rating.rate }}</p>
                        </div>
...
export default {
    ...
    computed: {
        ...
        // product() {
        //     console.info(this.id_produk)
        //     return product;
        // },
    },
    mounted(){
        this.fetchProductById((this.id_produk));
